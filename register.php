            ...
            <div id="inputContainer">
                <form action="register.php" id="loginForm" method="POST">
                    ...
                    <p>
                        ...
                        <input type="text" id="loginUsername" name="loginUsername" value="<?php getInputValue('loginUsername') ?>" placeholder="" required>
                    </p>
                    <p>
                ...
                <form action="register.php" id="registerForm" method="POST"   >
                    ...
                    <p>
                        ...
                        <input type="text" id="username" name="username" placeholder="" value="<?php getInputValue("username") ?>" required>
                    </p>
                    <p>
                        <?php 
                        ...
                        <input type="text" id="firstName" name="firstName" placeholder=""  value="<?php getInputValue("firstName") ?>" required>
                    </p>
                    <p>
                        <?php 
                        ...
                        <input type="text" id="lastName" name="lastName" placeholder=""  value="<?php getInputValue("lastName") ?>" required>
                    </p>
                    <p>
                        <?php 
                        ...
                        <input type="email" id="email" name="email" placeholder="" value="<?php getInputValue("email") ?>" required>
                    </p>
                    <p>
                        <label for="email2">Confirm email</label>
                        <input type="email" id="email2" name="email2" placeholder="" value="<?php getInputValue("email2") ?>" required>
                    </p>
                    <p>
                        <?php 
